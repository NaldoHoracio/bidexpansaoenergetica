...
#'
#' @examples
#' baixa_pof() # Baixa e extrai os dados da POF para o diretório padrão 'data/POF/'
#' baixa_pof('meu_diretorio_de_dados/') # Especifica um diretório diferente para o download e extração dos dados
#'
...
baixa_pof <- function(destination_dir = 'data/POF/')
{
